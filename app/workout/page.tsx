      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20">
        ...
        >
          ...
          <p className="text-lg text-neutral-600 dark:text-neutral-400 max-w-xl leading-relaxed">
            Design your training regimen with precision. Track progressive
            overload, monitor rest intervals, and optimize your physical output.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm text-neutral-500 dark:text-neutral-400">
                Compound movements focused on hypertrophy and max force
                production.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm text-neutral-500 dark:text-neutral-400">
                High-intensity interval training to improve cardiovascular
                capacity.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm text-neutral-500 dark:text-neutral-400">
                Explosive movements targeting speed and neuromuscular
                efficiency.
              </p>
            </div>
          </motion.div>
