      ...
      <div className="space-y-6">
         <div className="space-y-2">
            <label htmlFor="goal" className="text-sm font-medium">
                What is your main focus for the next 30 days? <span className="text-muted-foreground font-normal">(Optional)</span>
            </label>
         ...
         <div className="bg-card/50 border rounded-xl p-4">
             <h4 className="text-sm font-medium mb-2 text-muted-foreground">Examples:</h4>
